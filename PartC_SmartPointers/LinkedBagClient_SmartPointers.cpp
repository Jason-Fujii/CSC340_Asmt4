...
#include "Include_SmartPointers.h"
...
void displayBag(const unique_ptr<SPLinkedBag<string>>&);
...
int main() {
    ...
    cout << "--->>>>> Test 1 --->>>>>" << endl;
    unique_ptr<SPLinkedBag<string>> bag { make_unique <SPLinkedBag<string>>() };
...
void displayBag(const unique_ptr<SPLinkedBag<string>>& bag) {
    cout << "\n !Display bag: ";
